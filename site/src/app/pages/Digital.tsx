...
export default function Digital() {
  useSEO({ title: 'Zarq Digital | Digital Services & Technology', description: 'Zarq Digital builds practical websites, digital experiences and technology solutions for businesses, organisations and individuals.', path: '/digital' });
    ...
    <div>
      ...
      <section className="pt-12 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Zarq Digital</h1>
