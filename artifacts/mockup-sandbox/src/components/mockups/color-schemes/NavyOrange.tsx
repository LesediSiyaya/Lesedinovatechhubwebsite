// ZARQ — all dark, no letter colouring (clean, typographic, let the name speak alone)
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <section className="pt-12 pb-12 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          {/* Pure typographic — all dark, colour lives in the badge + glow only */}
          <h1 className="text-8xl md:text-9xl font-black mb-5 leading-none tracking-widest text-gray-900">
            ZARQ
          </h1>
