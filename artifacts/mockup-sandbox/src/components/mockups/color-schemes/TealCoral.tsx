// ZARQ — Q accent only (ZAR dark, Q in pink — the Q becomes the brand mark)
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "Inter, sans-serif" }}>
      <nav className="bg-white/95 backdrop-blur-sm shadow-sm px-6 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center h-16">
          <div className="flex items-center gap-2">
            ...
            {/* In the nav: ZAR dark, Q pink — clean and compact */}
            <span className="font-semibold text-xl tracking-widest">
              <span className="text-gray-900">ZAR</span><span style={{ color: "#ffc8dd" }}>Q</span>
            </span>
          </div>
      ...
      <section className="pt-12 pb-12 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          {/* ZAR solid dark, Q in pink — one accent letter, maximum contrast */}
