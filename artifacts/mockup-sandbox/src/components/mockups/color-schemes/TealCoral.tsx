// Zarq — capitalised treatment (conventional, authoritative)
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <section className="pt-12 pb-12 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          {/* Title — split colour on two letters to echo the old dual-word treatment */}
          <h1 className="text-7xl md:text-8xl font-bold mb-5 leading-none">
            <span style={{ color: "#030213" }}>Za</span><span style={{ color: "#e7c6ff" }}>r</span><span style={{ color: "#ffc8dd" }}>q</span>
          </h1>
