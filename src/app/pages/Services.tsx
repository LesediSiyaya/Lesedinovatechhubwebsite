...
export default function Services() {
  useSEO({ title: 'Professional Digital Services – Web Design, UI/UX & AI', description: `NovaTech Ignite offers affordable web design, mobile app development, UI/UX design, cybersecurity consulting, digital marketing, and AI solutions for businesses.`, path: '/services' });
