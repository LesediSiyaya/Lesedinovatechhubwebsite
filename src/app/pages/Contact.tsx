...
export default function Contact() {
  ...
  useSEO({ title: 'Contact Us – Get in Touch', description: `Contact NovaTech Ignite to join a program, request a service quote, or learn more. Reach us by email at lesnovatechub@gmail.com or WhatsApp 073 028 6401.`, path: '/contact' });
