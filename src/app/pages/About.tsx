...
export default function About() {
  useSEO({ title: 'About Us – Our Mission & Founder', description: `Learn about NovaTech Ignite's mission to bridge the digital divide for rural South African youth, our values, and the story behind our founder Lesedi Siyaya.`, path: '/about' });
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 sm:p-12 flex flex-col justify-center">
                ...
                <p className="text-sm font-medium text-gray-500 mb-6">Founder &amp; Director, NovaTech Ignite</p>
                <p className="text-gray-700 mb-4 leading-relaxed">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              NovaTech Ignite is backed by leading organisations committed to education, youth empowerment, and digital inclusion.
            </p>
          </div>
