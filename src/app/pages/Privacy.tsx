...
export default function Privacy() {
  useSEO({ title: 'Privacy Policy', description: `Read the NovaTech Ignite privacy policy to understand how we collect, use, and protect your personal information on our website and services.`, path: '/privacy' });
        ...
        <div className="max-w-3xl mx-auto prose prose-gray">
          ...
          <div className="mb-8">
            <p className="text-gray-600 leading-relaxed">
              NovaTech Ignite ("we", "our", or "us") is committed to protecting your privacy.
