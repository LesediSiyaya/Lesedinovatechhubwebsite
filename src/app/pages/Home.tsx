...
const testimonials = [
  {
    quote:
      'NovaTech Ignite creates an inspiring environment for young people to learn and grow through technology. Initiatives like this are important for bridging the digital gap in our communities and preparing youth for future opportunities.',
    name: 'Community Supporter',
    color: 'from-[#caf0f8] to-[#e7c6ff]',
  },
  {
    quote:
      'What stands out about NovaTech Ignite is its vision to make technology education more accessible to rural youth. The focus on coding, AI, and digital skills has the potential to positively impact many young lives.',
    name: 'Local Youth Advocate',
    color: 'from-[#e7c6ff] to-[#ffc8dd]',
  },
  {
    quote:
      'Seeing a youth-led initiative focused on innovation and community empowerment is truly motivating. NovaTech Ignite represents the kind of forward-thinking solutions needed to help young people succeed in a digital world.',
...
export default function Home() {
  useSEO({ title: 'Digital Education & Tech Services for South African Youth', description: `NovaTech Ignite empowers rural youth in South Africa with free IT programs, coding, cybersecurity training, and professional digital services. Join us and shape your digital future.`, path: '/' });
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 sm:gap-16">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                ...
                <img
                  src="/founder.jpg"
                  alt="Lesedi Siyaya, Founder of NovaTech Ignite"
                  loading="lazy"
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex items-center gap-3 justify-center md:justify-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Founder · NovaTech Ignite</p>
                </div>
              </div>
              <div className="mt-6">
                <Link
