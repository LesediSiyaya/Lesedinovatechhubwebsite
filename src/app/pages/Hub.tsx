...
export default function Hub() {
  useSEO({ title: 'Zarq Hub | Technology Learning & Community', description: 'Zarq Hub creates opportunities to learn practical technology skills through programmes, projects, mentorship and community initiatives.', path: '/hub' });
    ...
    <div>
      ...
      <section className="pt-12 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Zarq Hub</h1>
