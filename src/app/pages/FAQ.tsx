...
export default function FAQ() {
  useSEO({ title: 'FAQs – Frequently Asked Questions', description: `Find answers to common questions about NovaTech Ignite's free programs, digital services, eligibility, pricing, and how to get involved.`, path: '/faq' });
