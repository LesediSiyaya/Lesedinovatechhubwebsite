        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <span className="font-semibold text-lg sm:text-xl">NovaTech Ignite</span>
            </Link>

            {/* Desktop Menu */}
            <div className="hidden md:flex items-center gap-8">
              {navLinks.filter(({ path }) => path !== '/contact').map(({ path, label }) => (
                <Link
                  key={path}
                  to={path}
              ...
              <Link
                to="/contact"
                className="px-5 py-2 bg-gray-900 hover:bg-gray-700 text-white text-sm font-semibold rounded-full transition-all transform hover:scale-105"
              >
                Contact
              </Link>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-semibold text-lg">NovaTech Ignite</span>
              </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-400">
            <p>&copy; 2026 NovaTech Ignite. All rights reserved.</p>
